...
import ru.myapp.online_shop.databinding.ViewholderCategoryBinding
import ru.myapp.online_shop.model.CategoryModel
import ru.myapp.online_shop.activity.ListItemsActivity
...
class CategoryAdapter(val items: MutableList<CategoryModel>) :
    ...
    override fun onBindViewHolder(holder: CategoryAdapter.Viewholder, position: Int) {
        ...
        if (selectedPosition == position) {
            ...
            holder.binding.picCat.setBackgroundResource(R.drawable.grey_oval_bg)
            ImageViewCompat.setImageTintList(
                holder.binding.picCat,
                ColorStateList.valueOf(
                    ContextCompat.getColor(
